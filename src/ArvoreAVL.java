...
public class ArvoreAVL {
    ...
    public static void insertDados(ArvoreAVL arvoreAVL){
        ArvoreAVL tree = new ArvoreAVL();
        Node root = null;

        try {
            File file = new File("C:/Users/Public/Documents/av2pratica/src/dados.txt");
            ...
            System.out.println("Árvore AVL construída com sucesso:");
            tree.print(root);
            ...
            do {
                ...
                switch (opcao) {
                    case 1:
                        ...
                        int valorInserir = inputScanner.nextInt();
                        root = tree.insert(root, valorInserir);
                        System.out.println("Valor inserido com sucesso!");
                        break;

                    case 2:
                        System.out.print("Digite o valor a ser excluído: ");
                        int valorExcluir = inputScanner.nextInt();
                        tree.delete(valorExcluir);
